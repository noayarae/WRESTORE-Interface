...
print ("Input data: ")
print (parent1 + "\\shapefile\\ecw2.shp")# <-- SET THE 'shape' FILE-NAME
print ()
# reader = shapefile.Reader(parent1 + "\shapefile\sbs_wgs84.shp")
reader = shapefile.Reader(parent1 + "\shapefile\ecw2.shp")# <-- SET THE 'shape' FILE-NAME
...
print ("Output file: ")
print (parent1 + "\\ecw1.js")# <-- YOU CAN CHANGE THE OUTPUT FILE-NAME
geojson = open(parent1 + "\\ecw1.js", "w")# <-- YOU CAN CHANGE THE OUTPUT FILE-NAME
