...
<!--                       track when "Watershed" -->
                        <option class="trackable" id="watershed" value="Watershed" selected="selected">Watershed</option>
                        <?php
                        $y=1;
                        while($y<=127){
//                            /* track when "Sub-basin" */;
                           print "<option class='trackable' id=SB-$y value=S$y>Subbasin $y</option>";
                           $y++;
                        }
                        ?>
                    </select>
